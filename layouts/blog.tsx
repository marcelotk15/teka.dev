...
import { Flex, P, SocialShare, TableOfContents } from '@/components';

const editUrl = (slug: string) => `https://github.com//leerob.io/edit/main/data/blog/${slug}.mdx`;
const discussUrl = (slug: string) => `https://mobile.twitter.com/search?q=${encodeURIComponent(`https://teka.dev/blog/${slug}`)}`;

const BlogLayoutStyled = styled('div', {
  display: 'grid',
  gridGap: '$0',
